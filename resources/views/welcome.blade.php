...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  ?>
    <div class="carousel-item">
      <img src="{{ asset('img/projects/'.$image) }}" class="d-block" alt="{{ config('app.name', 'laravel') }}">
...
<div class="container-fluid bg-cyan" >
    ...
    <div class="row pb-5">
      <div class="col-12 text-center">
        <div class="container">
          <img src="{{ asset('img/map.png') }}" alt="{{ config('app.name', 'laravel') }}" class="img-fluid">
        </div>
      </div>
    </div>
...
<div class="container-fluid ">
  ...
  <div class="row pb-5 mb-5" style="background-image:url('{{ asset('img/diagonal.png') }}')">
