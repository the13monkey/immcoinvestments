...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->project_picture->move(public_path('/img/projects') ,$saveName);
    ...
    public function update(Request $request, Project $project)
    {
        ...
        if ( $image != '' ) {
            ...
            unlink(public_path('img/projects/'.$project->project_picture));
            $request->validate([
                'project_name' => 'required',
                'project_location' => 'required',
                'project_status' => 'required',
            ...
            $project->update($data);
            $image->move(public_path('/img/projects'), $saveName);
