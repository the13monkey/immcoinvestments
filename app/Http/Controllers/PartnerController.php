...
class PartnerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->partner_logo->move(public_path('/img/partners') ,$saveName);
    ...
    public function update(Request $request, Partner $partner)
    {
        ...
        if ( $image != '' ) {
            ...
            unlink(public_path('img/partners/'.$partner->partner_logo));
            $request->validate([
                'partner_name' => 'required',
                'partner_category' => 'required',
                'partner_logo' => 'image | mimes:jpeg,png,jpg,gif,svg',
            ...
            $partner->update($data);
            $image->move(public_path('/img/partners'), $saveName);
