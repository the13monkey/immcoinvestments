...
<ul class="nav justify-content-start py-3 px-0">
    ...
    <li class="nav-item w-100 pt-0 mt-0">
        <ul class="list-group" id="tab-pickers">
            ...
            <li class="list-group-item border-0 mb-2 bg-transparent pl-5">
                <a href="#" class="text-cyan display-8" id="businesses">Edit Business</a>
            </li>
            <li class="list-group-item border-0 mb-2 bg-transparent pl-5">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md col-md-6">
            <div class="card border-left-0 border-right-0 rounded-0">
               ...
               <form action="{{ route('biz.update', $biz->id) }}" method="post" class="py-5">
               @csrf
               @method('PUT')
                    <div class="row">
                        <div class="col-md-12 col-md mb-3">
                            <label for="biz_name">Business Category Name</label>
                            <input type="text" class="form-control" id="biz_name" name="biz_name" required value="{{ $biz->biz_name }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-12 mb-3">
                            <label for="biz_description">Business Category Description</label>
                            <textarea class="form-control" id="biz_description" name="biz_description" required rows="10">{{ $biz->biz_description }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-12 mb-3 my-5 w-100">
                            <button type="submit" class="btn btn-primary w-100 d-block">Edit business category</button>
                        </div>
                    </div>
               </form>
            </div>
