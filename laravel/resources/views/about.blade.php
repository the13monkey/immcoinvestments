...
@section('content')
    ...
    <div id="video-background">
        <video playsinline autoplay muted loop id="my-video" poster="" id="video-background">
            <source src="{{ asset('storage/img/video_original.mp4') }}" type="video/mp4">
        </video>
    ...
    <div class="container-fluid bg-cyan" >
        ...
        <div class="row pb-5">
            <div class="col-12 text-center">
                <div class="container">
                    <img src="{{ asset('storage/img/usoffice.jpg') }}" alt="{{ config('app.name', 'laravel') }}" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5 mt-md-5 pb-5 leadership">
            <div class="col-md col-md-6 px-5 text-center mb-3">
                <img src="{{ asset('storage/img/leaders/'.$image) }}" alt="{{ config('app.name', 'laravel') }}" class="mr-0" width="70%">
            </div>
