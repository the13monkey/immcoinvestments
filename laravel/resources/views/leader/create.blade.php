...
<ul class="nav justify-content-start py-3 px-0">
    ...
    <li class="nav-item w-100 pt-0 mt-0">
        <ul class="list-group" id="tab-pickers">
            ...
            <li class="list-group-item border-0 mb-2 bg-transparent pl-5">
                <a href="{{ route('leader.create') }}" class="text-cyan display-8" id="leadership">New Team Leader</a>
            </li>
            <li class="list-group-item border-0 mb-2 bg-transparent pl-5">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md col-md-6">
            <div class="card border-left-0 border-right-0 rounded-0">
               ...
               <form action="{{ route('leader.store') }}" method="post" class="py-5" enctype="multipart/form-data">
               @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md mb-3">
                            ...
                            <input type="text" class="form-control" id="leader_title" name="leader_title" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-12 mb-3">
                            <label for="leader_description">Bio</label>
                            <textarea class="form-control" id="leader_description" name="leader_description" required rows="10"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-6 mb-3">
                            ...
                            <div id="leader_picture_holder"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-12 mb-3 my-5 w-100">
                            <button type="submit" class="btn btn-primary w-100 d-block">Add new team leader</button>
                        </div>
                    </div>
               </form>
            </div>
