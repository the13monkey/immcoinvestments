...
<div class="container-fluid">
    ...
    <div class="row pb-5 mb-5 d-flex justify-content-center" style="background-image:url('{{ asset('storage/img/diagonal.png') }}')">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-horizontal border-0 pl-0" >
                        <li class="list-group-item pl-0 border-0 modal-container" data-toggle="modal" data-target="#exampleModal">
                            <img src="{{ asset('storage/img/plaques/p-lg1.jpg') }}" alt="{{ config('app.name', 'laravel') }}" class="img-thumbnail">
                        </li>
                        <li class="list-group-item pl-0 border-0 modal-container" data-toggle="modal" data-target="#exampleModal">
                            <img src="{{ asset('storage/img/plaques/p-lg2.jpg') }}" alt="{{ config('app.name', 'laravel') }}" class="img-thumbnail">
                        </li>
                        <li class="list-group-item pl-0 border-0 modal-container" data-toggle="modal" data-target="#exampleModal">
                            <img src="{{ asset('storage/img/plaques/p-moxy.jpg') }}" alt="{{ config('app.name', 'laravel') }}" class="img-thumbnail">
                        </li>
                        <li class="list-group-item pl-0 border-0 modal-container" data-toggle="modal" data-target="#exampleModal">
                            <img src="{{ asset('storage/img/plaques/p-wst.jpg') }}" alt="{{ config('app.name', 'laravel') }}" class="img-thumbnail">
                        </li>
                        <li class="list-group-item pl-0 border-0 modal-container" data-toggle="modal" data-target="#exampleModal">
                            <img src="{{ asset('storage/img/plaques/p-wst2.jpg') }}" alt="{{ config('app.name', 'laravel') }}" class="img-thumbnail">
                        </li>
                    </ul>
                </div>
            </div>
