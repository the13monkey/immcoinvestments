...
<ul class="nav justify-content-start py-3 px-0">
    ...
    <li class="nav-item w-100 pt-0 mt-0">
        <ul class="list-group" id="tab-pickers">
            ...
            <li class="list-group-item border-0 mb-2 bg-transparent pl-5">
                <a href="{{ route('partner.create') }}" class="text-cyan display-8" id="partners">New Partner</a>
            </li>
        </ul>
    </li>
</ul>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md col-md-6">
            <div class="card border-left-0 border-right-0 rounded-0">
               ...
               <form action="{{ route('partner.store') }}" method="post" class="py-5" enctype="multipart/form-data">
               @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md mb-3">
                            ...
                            <input type="text" class="form-control" id="partner_category" name="partner_category" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-6 mb-3">
                            ...
                            <div id="partner_picture_holder"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md col-md-12 mb-3 my-5 w-100">
                            <button type="submit" class="btn btn-primary w-100 d-block">Add new partner</button>
                        </div>
                    </div>
               </form>
            </div>
