                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item py-4 table-responsive-md">
                        <table>
                            <tr>
                                <td class="align-top">
                                    <img src="{{ asset('storage/img/projects/'.$image) }}" alt="{{ config('app.name') }}" class="rounded float-left mr-5" width="200">
                                </td>
                                <td class="align-top">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item py-4 table-responsive-md">
                        <table>
                            <tr>
                                <td class="align-top">
                                    <img src="{{ asset('storage/img/leaders/'.$image) }}" alt="{{ config('app.name') }}" class="rounded float-left mr-5" width="100">
                                </td>
                                <td class="align-top">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item py-4 table-responsive-md">
                        <table>
                            <tr>
                                <td class="align-top">
                                    <img src="{{ asset('storage/img/partners/'.$image) }}" alt="{{ config('app.name') }}" class="rounded float-left mr-5" width="100">
                                </td>
                                <td class="align-top">
