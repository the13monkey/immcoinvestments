...
class LeaderController extends Controller
{
   ...
   //      
        ...
        $request->leader_picture->move(storage_path('app/public/img/leaders'), $saveName);
    ...
    public function update(Request $request, Leader $leader)
    {
        ...
        if ( $image != '' ) { //New image is set
            ...
            unlink(storage_path('app/public/img/leaders/'.$leader->leader_picture));
            $request->validate([
                'leader_name' => 'required',
                'leader_title' => 'required',
                'leader_description' => 'required',
            ...
            $leader->update($data);
            $image->move(storage_path('app/public/img/leaders'), $saveName);
